            ...
            <div class="profile__user user container">
                <div class="profile__user-info user__info">
                    <div class="profile__avatar user__avatar">
                        <?php if (!empty($owner['avatar'] ?? null)) : ?>
                            <img class="profile__picture user__picture" src="img/<?= $owner['avatar'] ?>"
                                 alt="Аватар пользователя">
                        <?php endif; ?>
                    </div>
                    <div class="profile__name-wrapper user__name-wrapper">
                        <span class="profile__name user__name"><?= htmlspecialchars($owner['username'] ?? '') ?></span>
        ...
        <div class="profile__tabs-wrapper tabs">
            <div class="container">
                ...
                <div class="profile__tab-content">
                    <section
                        class="profile__posts tabs__content <?= ($tab === 'posts') ? 'tabs__content--active' : '' ?>">
                        <h2 class="visually-hidden">Публикации</h2>
                        <?php foreach ($posts as $post) : ?>
                            <article class="profile__post post post-<?= $post['type_class']; ?>">
                                <header class="post__header">
                                    <h2>
                                        <a href="post.php?id=<?= $post['id'] ?>"><?= htmlspecialchars($post['heading']) ?? '' ?></a>
                                    </h2>
                                </header>
                    ...
                    <section
                        class="profile__likes tabs__content <?= ($tab === 'likes') ? 'tabs__content--active' : '' ?>">
                                    ...
                                    <div class="post-mini__user-info user__info">
                                        ...
                                        <div class="post-mini__name-wrapper user__name-wrapper">
                                            <a class="post-mini__name user__name"
                                               href="profile.php?id=<?= $like['user_id'] ?>">
                            ...
                            <?php foreach ($subscribes as $subscribe) : ?>
                                <li class="post-mini post-mini--photo post user">
                                    <div class="post-mini__user-info user__info">
                                        ...
                                        <div class="post-mini__name-wrapper user__name-wrapper">
                                            <a class="post-mini__name user__name"
                                               href="profile.php?id=<?= $subscribe['user_id'] ?? '' ?>">
