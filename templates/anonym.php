        ...
        <section class="authorization">
            ...
            <form class="authorization__form form" action="#" method="post">
                <div class="authorization__input-wrapper form__input-wrapper">
                    ...
                    <label
                        class="visually-hidden <?= (!empty($form_errors['login'] ?? null)) ? 'form__input-section--error' : '' ?>">Логин</label>
                ...
                <div class="authorization__input-wrapper form__input-wrapper">
                    ...
                    <label
                        class="visually-hidden <?= (!empty($form_errors['password'] ?? null)) ? 'form__input-section--error' : '' ?>">Пароль</label>
        ...
        <div class="footer__container container">
            <div class="footer__site-info">
                ...
                <p class="footer__license">
                    ...
                    рамках проекта защищены в соответствии с положениями 4 части Гражданского Кодекса Российской
                    Федерации.
                </p>
            </div>
